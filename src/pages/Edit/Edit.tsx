...
const Edit: React.FC = () => {
  const { token, displayProd, editModalOpen, closeModal, editProd } =
    useAppContext();
              ...
              {displayProd.images!.map((prev: string, index: number) => {
                return (
                  <img
                    key={index}
                    src={prev}
                    alt={`product pic number ${index} to upload`}
                    className="prodImg"
                  />
                );
              })}
            ...
            >
              ...
              >
                <TextField
                  ...
                  defaultValue={displayProd?.description}
                />
              </Grid>
              <Stack
                className="priceAndInventory"
                sx={{
                  display: "flex",
                  flexDirection: "row",
                  justifyContent: "center",
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <TextField
                      ...
                      defaultValue={displayProd?.price}
                    />
                  </Box>
                </Stack>
                <Grid
                ...
                >
                  <TextField
                    ...
                    defaultValue={displayProd?.brand}
                  />
                </Grid>
              </Stack>

              <Stack
                className="categorySizeSex"
                sx={{
                  display: "flex",
                  flexDirection: "row",
                  mb: 2,
